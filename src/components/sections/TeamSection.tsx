  ...
  const teamMembers = [
    {
      ...
      highlight: true,
      description:
        "Led the team through planning, coordination, and presentations, while also taking charge of technical coding and developing Mist’s AI-powered features.",
      links: { github: "https://github.com/freddycleann", email: "viktor.pongpisut@gmail.com" },
    },
    {
      name: "Vivien Therese Villalobos",
      nickname: "Vivien",
      role: "Visual Content & Landing Page Developer",
      highlight: false,
      description:
        "Crafted the landing page using Vite and React, created Mist’s video while also assisting in team planning, presentation, research, and documentation.",
    ...
    },
    {
      ...
      highlight: false,
      description:
        "Designed and implemented the app’s user interface and core functionality using FlutterFlow, ensuring usability and a smooth user experience, while also contributing to technical presentations and feature development.",
    ...
    },
    {
      ...
      highlight: false,
      description:
        "Helped prepare and present the project during key milestones, supporting live demos and team communication.",
    ...
    },
    {
      ...
      highlight: false,
      description:
        "Supported the team by assisting with presentations and communicating project progress throughout development.",
      ...
      <div className="container mx-auto px-4">
        <div className="text-center mb-16">
          <h2 className="text-3xl md:text-5xl font-bold mb-6">
            ...
            <span className="bg-gradient-primary bg-clip-text text-transparent">MIST</span>
          </h2>
